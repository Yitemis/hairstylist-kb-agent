...
# Windows + asyncpg 兼容：强制 SelectorEventLoop
...
def seed_business_data(event_loop):
    """Session 级：seed 业务数据（branches + stylists + services）。"""
    async def _seed():
